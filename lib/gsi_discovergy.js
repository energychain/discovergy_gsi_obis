    ...
    return new Promise( async function (resolve, reject)  {
      http_request("https://"+escape(config.DISCOVERGY_ACCOUNT)+":"+escape(config.DISCOVERGY_PASSWORD)+"@api.discovergy.com/public/v1/last_reading?meterId="+meter.meterId,async function(e,r,b) {
          try {
            ...
            if(typeof reading.values.power1 != "undefined") meter["power1"] = reading.values.power1;
            if(typeof reading.values.power2 != "undefined") meter["power2"] = reading.values.power2;
            if(typeof reading.values.power3 != "undefined") meter["power3"] = reading.values.power3;
            if(typeof reading.values.energyOut != "undefined") meter["2.8.0"] = reading.values.energyOut;
