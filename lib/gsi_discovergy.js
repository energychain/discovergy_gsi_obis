...
module.exports = function(config) {
  ...
  const meterStorage = storage.create({ dir: 'storageMeter', ttl: (3599900) })
  this.config = config;
  ...
  const  _getGSI = function(meter) {
    return new Promise( async function (resolve, reject)  {
        ...
        const  _getGSIremote = function(gsidata) {
          return new Promise( async function (resolve, reject)  {
            http_request.post("https://corrently.de/api/stromdao/metering",{form:gsidata},function(e,r,b) {
